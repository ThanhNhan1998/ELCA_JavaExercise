...
public class FileExcelReader implements FileExtension {
    ...
    public List<Company> readFile(String path) throws FileExtensionUnformatted {
        ...
        try {
            inputStream = new FileInputStream(new File(Constant.excelFilePath));

            workbook = getWorkbook(inputStream, Constant.excelFilePath);
                ...
                while (cellIterator.hasNext()){
                    ...
                    switch (colIndex){
                        ...
                        case COLUMN_INDEX_HEADQUARTER:
                            ...
                            company.setHeadQuarter(isHeadQuarter == 1.0 ? true : false);
                            break;
                        default:
                            break;
                    }
